...
func TestBuiltinApplication(t *testing.T) {
	...
	if response, err := session.Service(context.TODO(), wmpci.WMPRequest{"domain_name": {"example.com"}, "ip_address": {"23.192.228.84"}, "as": {"AS20940"}}); err != nil {
		panic(err)
	} else {
