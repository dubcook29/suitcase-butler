module github.com/suitcase/butler/built_wmp

go 1.24.1

replace github.com/suitcase/butler => ../

replace github.com/suitcase/butler/wmpci => ../wmpci
...
require (
	...
	github.com/suitcase/butler/wmpci v0.0.0-00010101000000-000000000000
)
